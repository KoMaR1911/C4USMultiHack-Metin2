...
void Globals::ReAddressingInstances()
{
	...
	case ServerName::METINPL:
	{
		...
		//"[1]A1 ? ? ? ? D9 6C 24";
		Globals::pCPythonNetworkStreamInstance = Globals::hEntryBaseAddress + 0x21f8380; // [100 ] [34 / 34]
		Globals::pCPythonCharacterManagerInstance = Globals::hEntryBaseAddress + 0x21f4ee4; // [100 ] [11 / 11]
		Globals::pCPythonBackgroundInstance = Globals::hEntryBaseAddress + 0x21f4ee0; // [100 ] [5 / 5]
		Globals::pCItemManagerInstance = Globals::hEntryBaseAddress + 0x21f4edc; // [100 ] [27 / 27]
		Globals::pCPythonItemInstance = Globals::hEntryBaseAddress + 0x21f845c; // [100 ] [1 / 1]
		Globals::pCPythonApplicationInstance = Globals::hEntryBaseAddress + 0x21fa6dc; // [100 ] [18 / 18]
		Globals::pCPythonNonPlayerInstance = Globals::hEntryBaseAddress + 0x21f4eec; // [100 ] [1 / 1]
		Globals::pCPythonPlayerInstance = Globals::hEntryBaseAddress + 0x21f4ed8; // [100 ] [51 / 51]
		Globals::pCResourceManagerInstance = Globals::hEntryBaseAddress + 0x21f8418; // [100 ] [1 / 1]
		Globals::pCGraphicBasems_lpd3dDevice = Globals::hEntryBaseAddress + 0x2201738; 
		break;
	}
...
void Globals::ReAddressingLocas()
{
	...
	case ServerName::METINPL:
	{
		...
		Globals::pCActorInstanceTestActorCollision = Globals::hEntryBaseAddress + 0x3a5300; // [100 ] [1 / 1]
		...
		Globals::pCInstanceBase__SetAffect = Globals::hEntryBaseAddress + 0x6a570; // [100 ] [1 / 1]
		Globals::pCItemDataGetName = Globals::hEntryBaseAddress + 0x3a7c70; // [100 ] [1 / 1]
		Globals::pCItemManagerGetItemDataPointer = Globals::hEntryBaseAddress + 0x3aa400; // [100 ] [1 / 1]
		Globals::pCPythonBackgroundLocalPositionToGlobalPosition = Globals::hEntryBaseAddress + 0x76e10; // [100 ] [1 / 1]
		Globals::pCNetworkStreamConnect = Globals::hEntryBaseAddress + 0x432a50; // [100 ] [1 / 1]
		Globals::pCNetworkStream__DirectEnterMode_Set = Globals::hEntryBaseAddress + 0x1ec740; // [100 ] [1 / 1]
		Globals::pCNetworkStreamGetAccountCharacterSlotDataz = Globals::hEntryBaseAddress + 0x1ea7a0; // [100 ] [1 / 1]
		Globals::pCNetworkStreamIsOnline = Globals::hEntryBaseAddress + 0x4328c0; // [100 ] [1 / 1]
		Globals::pCNetworkStreamPeek = Globals::hEntryBaseAddress + 0x432870; // [100 ] [1 / 1]
		Globals::pCNetworkStreamRecv = Globals::hEntryBaseAddress + 0x432f00; // [100 ] [1 / 1]
		Globals::pCNetworkStreamSend = Globals::hEntryBaseAddress + 0x432f30; // [100 ] [1 / 1]
		Globals::pCNetworkStreamSendSequence = Globals::hEntryBaseAddress + 0x432fa0; // [100 ] [1 / 1]
		Globals::pCPhysicsObjectIncreaseExternalForce = Globals::hEntryBaseAddress + 0x3cdef0; // [100 ] [1 / 1]
		Globals::pCPythonApplicationProcess = Globals::hEntryBaseAddress + 0x1c6c50; // [100 ] [1 / 1]
		Globals::pCPythonApplicationRenderGame = Globals::hEntryBaseAddress + 0x1c60e0; // [100 ] [1 / 1]
		Globals::pCPythonCharacterManagerGetInstancePtr = Globals::hEntryBaseAddress + 0x84240; // [100 ] [1 / 1]
		Globals::pCPythonChatAppendChat = Globals::hEntryBaseAddress + 0x14f4e0; // [100 ] [1 / 1]
		Globals::pCPythonEventManagerRegisterEventSetFromString = Globals::hEntryBaseAddress + 0x9b090; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamConnectGameServer = Globals::hEntryBaseAddress + 0x1ea880; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamGetMainActorSkillGroup = Globals::hEntryBaseAddress + 0x1ec690; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendAddFlyTargetingPacket = Globals::hEntryBaseAddress + 0x2023b0; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendAttackPacket = Globals::hEntryBaseAddress + 0x201ee0; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendCharacterStatePacket = Globals::hEntryBaseAddress + 0x1fbd80; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendChatPacket = Globals::hEntryBaseAddress + 0x1fbf80; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendEmoticon = Globals::hEntryBaseAddress + 0x211840; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendExchangeAcceptPacket = Globals::hEntryBaseAddress + 0x200ed0; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendExchangeItemAddPacket = Globals::hEntryBaseAddress + 0x200e10; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendExchangeStartPacket = Globals::hEntryBaseAddress + 0x200ca0; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0x206d50; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendFishingQuitPacket = Globals::hEntryBaseAddress + 0x206e40; // [100 %] [1 / 1]
		Globals::pCPythonNetworkStreamSendGiveItemPacket = Globals::hEntryBaseAddress + 0x206ec0; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendItemDropPacketNew = Globals::hEntryBaseAddress + 0x222680; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendItemMovePacket = Globals::hEntryBaseAddress + 0x2228b0; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendItemPickUpPacket = Globals::hEntryBaseAddress + 0x222b40; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendItemUsePacket = Globals::hEntryBaseAddress + 0x222410; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendOnClickPacket = Globals::hEntryBaseAddress + 0x1fe280; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendScriptAnswerPacket = Globals::hEntryBaseAddress + 0x201280; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendShootPacket = Globals::hEntryBaseAddress + 0x202330; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendShopBuyPacket = Globals::hEntryBaseAddress + 0x222210; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendShopEndPacket = Globals::hEntryBaseAddress + 0x222190; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + 0x1f2460; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0x201f60; // [100 ] [4 / 4]
		Globals::pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0x1fbf10; // [100 ] [3 / 3]
		Globals::pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0x1fdaa0; // [100 ] [2 / 2]
		Globals::pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0x1eda90; // [100 ] [4 / 4]
		Globals::pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0xe6e30; // [100 ] [4 / 4]
		Globals::pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0x11fed0; // [100 ] [4 / 4]
		Globals::pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0xf07f0; // [100 ] [4 / 4]
		Globals::pCPythonPlayerGetItemMetinSocket = Globals::hEntryBaseAddress + 0xf0d30; // [100 ] [5 / 5]
		Globals::pCPythonPlayerGetMainCharacterIndex = Globals::hEntryBaseAddress + 0xefaf0; // [100 ] [3 / 3]
		Globals::pCPythonPlayerGetName = Globals::hEntryBaseAddress + 0xf0350; // [100 ] [3 / 3]
		Globals::pCPythonPlayerGetRace = Globals::hEntryBaseAddress + 0xefc60; // [100 ] [4 / 4]
		Globals::pCPythonPlayerGetStatus = Globals::hEntryBaseAddress + 0xf0310; // [100 ] [3 / 3]
		Globals::pCPythonPlayerGetTargetVID = Globals::hEntryBaseAddress + 0x1072f0; // [100 ] [4 / 4]
		Globals::pCPythonPlayerIsSkillActive = Globals::hEntryBaseAddress + 0xf2690; // [100 ] [4 / 4]
		Globals::pCPythonPlayerIsSkillCoolTime = Globals::hEntryBaseAddress + 0xf2660; // [100 ] [5 / 5]
		Globals::pCPythonPlayerNEW_Fishing = Globals::hEntryBaseAddress + 0x108030; // [100 ] [1 / 1]
		Globals::pCPythonPlayerNEW_GetMainActorPtr = Globals::hEntryBaseAddress + 0xef5a0; // [100 ] [3 / 3]
		Globals::pCPythonPlayerSetAttackKeyState = Globals::hEntryBaseAddress + 0x108fa0; // [100 ] [1 / 1]
		Globals::pCPythonPlayerSetTarget = Globals::hEntryBaseAddress + 0x107350; // [100 ] [3 / 3]
		Globals::pCPythonPlayer__OnClickActor = Globals::hEntryBaseAddress + 0x107880; // [100 ] [3 / 3]
		Globals::pCPythonPlayer__OnPressActor = Globals::hEntryBaseAddress + 0x1079e0; // [100 ] [3 / 3]
		Globals::pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x435bf0; // [100 ] [3 / 3]
		Globals::pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x41e0d0; // [100 ] [1 / 1]
		Globals::pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x448ae0; // [100 ] [2 / 2]
		Globals::pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x46c140; // [100 ] [2 / 2]
		Globals::pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x433780; // [100 ] [2 / 2]
		Globals::pCInstanceBaseIsWaiting = Globals::hEntryBaseAddress + 0x72df0; // [100 ] [3 / 3]
		Globals::pCInstanceBaseSetRotation = Globals::hEntryBaseAddress + 0x73410; // [100 ] [2 / 2]
		Globals::pCInstanceBase__GetBackgroundHeight = Globals::hEntryBaseAddress + 0x550a0; // [100 ] [2 / 2]
		Globals::pCResourceReload = Globals::hEntryBaseAddress + 0x436190; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetItemCount = Globals::hEntryBaseAddress + 0xf0a60; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetItemAttribute = Globals::hEntryBaseAddress + 0x1fd750; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendItemUseToItemPacket = Globals::hEntryBaseAddress + 0x2225c0; // [50 ] [1 / 2]
		break;
	}
